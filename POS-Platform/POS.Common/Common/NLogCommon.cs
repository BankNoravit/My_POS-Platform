...
namespace POS.Common
{
    public interface INLogCommon
    {
        ...
        void Error(Exception exception, out string trackingCode);
    ...
    public partial class NLogCommon : INLogCommon
    {
        ...
        public NLogCommon()
        {
            this._logger = LogManager.GetLogger("NLogLogger");
        }
        ...
        public void Error(Exception exception, out string trackingCode)
        {
            trackingCode = Guid.NewGuid().ToString();
            this.Error(exception, string.Format("Tracking Code: {0}", trackingCode));
        }
