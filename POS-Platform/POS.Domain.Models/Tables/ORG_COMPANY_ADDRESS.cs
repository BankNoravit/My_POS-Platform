...
namespace POS.Domain.Models
{
    ...
    public class ORG_COMPANY_ADDRESS
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"COMPANY_ADDRESS_ID", Order = 1, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        [Key]
        public System.Guid COMPANY_ADDRESS_ID { get; set; } // COMPANY_ADDRESS_ID (Primary key)
        ...
        public virtual ORG_COMPANY ORG_COMPANY { get; set; } // FK_ORG_COMPANY_ADDRESS_COMPANY_ID
        public virtual SYS_DISTRICT SYS_DISTRICT { get; set; } // FK_ORG_COMPANY_ADDRESS_DISTRICT_ID
        public virtual SYS_SUB_DISTRICT SYS_SUB_DISTRICT { get; set; } // FK_ORG_COMPANY_ADDRESS_SUB_DISTRICT_ID
        public virtual SYS_USER CREATED_BY { get; set; } // FK_ORG_COMPANY_ADDRESS_CREATED_BY_ID
        public virtual SYS_USER LAST_UPDATED_BY { get; set; } // FK_ORG_COMPANY_ADDRESS_LAST_UPDATED_BY_ID

        public ORG_COMPANY_ADDRESS()
        {
        }
    }
}
