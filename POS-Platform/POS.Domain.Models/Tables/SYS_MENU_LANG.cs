...
{
    [Table("SYS_MENU_LANG")]
    public class SYS_MENU_LANG
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"MENU_LANG_ID", Order = 1, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        [Key]
        public System.Guid MENU_LANG_ID { get; set; } // MENU_LANG_ID (Primary key)
        ...
        public virtual SYS_MENU SYS_MENU { get; set; } // FK_SYS_MENU_LANG_MENU_ID
        public virtual SYS_USER CREATED_BY { get; set; } // FK_SYS_MENU_LANG_CREATED_BY_ID
        public virtual SYS_USER LAST_UPDATED_BY { get; set; } // FK_SYS_MENU_LANG_LAST_UPDATED_BY_ID

        public SYS_MENU_LANG()
        {
        }
    }
}
