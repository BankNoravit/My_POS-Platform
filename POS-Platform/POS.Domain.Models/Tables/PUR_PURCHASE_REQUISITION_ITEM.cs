...
{
    [Table("PUR_PURCHASE_REQUISITION_ITEM")]
    public class PUR_PURCHASE_REQUISITION_ITEM
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"PURCHASE_REQUISITION_ITEM_ID", Order = 1, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        [Key]
        public System.Guid PURCHASE_REQUISITION_ITEM_ID { get; set; } // PURCHASE_REQUISITION_ITEM_ID (Primary key)

        [Column(@"PURCHASE_REQUISITION_ID", Order = 2, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        ...
        public virtual ICollection<PUR_PURCHASE_REQUISITION_ITEM_LOCATION> PUR_PURCHASE_REQUISITION_ITEM_LOCATION { get; set; } // PUR_PURCHASE_REQUISITION_ITEM_LOCATION.FK_PUR_PURCHASE_REQUISITION_ITEM_LOCATION_PURCHASE_REQUISITION_ITEM_ID

        public virtual INV_PRODUCT INV_PRODUCT { get; set; } // FK_PUR_PURCHASE_REQUISITION_ITEM_PRODUCT_ID
        public virtual INV_UOM INV_UOM { get; set; } // FK_PUR_PURCHASE_REQUISITION_ITEM_UOM_ID
        public virtual PUR_PURCHASE_REQUISITION PUR_PURCHASE_REQUISITION { get; set; } // FK_PUR_PURCHASE_REQUISITION_ITEM_PURCHASE_REQUISITION_ID
        public virtual SYS_USER CREATED_BY { get; set; } // FK_PUR_PURCHASE_REQUISITION_ITEM_CREATED_BY_ID
        public virtual SYS_USER LAST_UPDATED_BY { get; set; } // FK_PUR_PURCHASE_REQUISITION_ITEM_LAST_UPDATED_BY_ID

        public PUR_PURCHASE_REQUISITION_ITEM()
        {
