...
{
    [Table("INV_PRODUCT_IMAGE")]
    public class INV_PRODUCT_IMAGE
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"PRODUCT_IMAGE_ID", Order = 1, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        [Key]
        public System.Guid PRODUCT_IMAGE_ID { get; set; } // PRODUCT_IMAGE_ID (Primary key)
        ...
        [Column(@"IMAGE_URL", Order = 4, TypeName = SQLSERVER_CONST.VARCHAR_300)]
        [MaxLength(300)]
        ...
        public virtual INV_PRODUCT INV_PRODUCT { get; set; } // FK_INV_PRODUCT_IMAGE_PRODUCT_ID
        public virtual SYS_USER CREATED_BY { get; set; } // FK_INV_PRODUCT_IMAGE_CREATED_BY_ID
        public virtual SYS_USER LAST_UPDATED_BY { get; set; } // FK_INV_PRODUCT_IMAGE_LAST_UPDATED_BY_ID

        public INV_PRODUCT_IMAGE()
        {
        }
    }
}
