...
{
    [Table("INV_WAREHOUSE_ADDRESS")]
    public class INV_WAREHOUSE_ADDRESS
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"WAREHOUSE_ADDRESS_ID", Order = 1, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        [Key]
        public System.Guid WAREHOUSE_ADDRESS_ID { get; set; } // WAREHOUSE_ADDRESS_ID (Primary key)

        [Column(@"WAREHOUSE_ID", Order = 2, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        ...
        public virtual INV_WAREHOUSE INV_WAREHOUSE { get; set; } // FK_INV_WAREHOUSE_ADDRESS_BRANCH_ID
        public virtual SYS_DISTRICT SYS_DISTRICT { get; set; } // FK_INV_WAREHOUSE_ADDRESS_DISTRICT_ID
        public virtual SYS_SUB_DISTRICT SYS_SUB_DISTRICT { get; set; } // FK_INV_WAREHOUSE_ADDRESS_SUB_DISTRICT_ID
        public virtual SYS_USER CREATED_BY { get; set; } // FK_INV_WAREHOUSE_ADDRESS_CREATED_BY_ID
        public virtual SYS_USER LAST_UPDATED_BY { get; set; } // FK_INV_WAREHOUSE_ADDRESS_LAST_UPDATED_BY_ID

        public INV_WAREHOUSE_ADDRESS()
        {
        }
    }
}
