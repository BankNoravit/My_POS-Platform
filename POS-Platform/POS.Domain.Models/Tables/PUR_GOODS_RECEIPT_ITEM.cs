...
{
    [Table("PUR_GOODS_RECEIPT_ITEM")]
    public class PUR_GOODS_RECEIPT_ITEM
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"GOODS_RECEIPT_ITEM_ID", Order = 1, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        [Key]
        public System.Guid GOODS_RECEIPT_ITEM_ID { get; set; } // GOODS_RECEIPT_ITEM_ID (Primary key)

        [Column(@"GOODS_RECEIPT_ID", Order = 2, TypeName = SQLSERVER_CONST.UNIQUE)]
        [Required]
        public System.Guid GOODS_RECEIPT_ID { get; set; } // GOODS_RECEIPT_ID
        ...
        public virtual ICollection<PUR_GOODS_RECEIPT_ITEM_SERIAL> PUR_GOODS_RECEIPT_ITEM_SERIAL { get; set; } // PUR_GOODS_RECEIPT_ITEM_SERIAL.FK_PUR_GOODS_RECEIPT_ITEM_SERIAL_GOODS_RECEIPT_ITEM_ID

        public virtual INV_PRODUCT INV_PRODUCT { get; set; } // FK_PUR_GOODS_RECEIPT_ITEM_PRODUCT_ID
        public virtual INV_UOM INV_UOM { get; set; } // FK_PUR_GOODS_RECEIPT_ITEM_UOM_ID
        public virtual PUR_GOODS_RECEIPT PUR_GOODS_RECEIPT { get; set; } // FK_PUR_GOODS_RECEIPT_ITEM_GOODS_RECEIPT_ID
        public virtual SYS_USER CREATED_BY { get; set; } // FK_PUR_GOODS_RECEIPT_ITEM_CREATED_BY_ID
        public virtual SYS_USER LAST_UPDATED_BY { get; set; } // FK_PUR_GOODS_RECEIPT_ITEM_LAST_UPDATED_BY_ID

        public PUR_GOODS_RECEIPT_ITEM()
        {
