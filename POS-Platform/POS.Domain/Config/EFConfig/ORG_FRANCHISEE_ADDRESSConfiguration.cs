...
{
    public class ORG_FRANCHISEE_ADDRESSConfiguration : IEntityTypeConfiguration<ORG_FRANCHISEE_ADDRESS>
    {
        public void Configure(EntityTypeBuilder<ORG_FRANCHISEE_ADDRESS> builder)
        {
            ...
            builder.HasOne(a => a.CREATED_BY)
                   .WithMany(b => b.ORG_FRANCHISEE_ADDRESS_CREATED_BY)
                   .HasForeignKey(c => c.CREATED_BY_ID)
                   .OnDelete(DeleteBehavior.Restrict);

            builder.HasOne(a => a.LAST_UPDATED_BY)
                   .WithMany(b => b.ORG_FRANCHISEE_ADDRESS_LAST_UPDATED_BY)
                   .HasForeignKey(c => c.LAST_UPDATED_BY_ID)
                   .OnDelete(DeleteBehavior.Restrict);

            builder.HasOne(a => a.ORG_FRANCHISEE)
                   .WithMany(b => b.ORG_FRANCHISEE_ADDRESS)
