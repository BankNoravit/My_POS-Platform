        ...
        {   // This function required: User-Defined Table Types
            ...
            if (param != null && param.Count() > 0)
            {
                foreach (var p in param)
                {
                    ...
                    {
                        r["FROM_VALUE"] = item1Datetime.AddHours(00).AddMinutes(00).AddSeconds(00).ToString(sqlDatetimeFormat);
                    }
                    else
                    {
                    ...
                    {
                        r["TO_VALUE"] = item2Datetime.AddHours(23).AddMinutes(59).AddSeconds(59).ToString(sqlDatetimeFormat);
                    }
                    else
                    {
